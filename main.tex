...
\noindent  \textcolor{gray}{\large Eivor Øsebak-Loe} \\
\vspace{1cm}
...
% \ifdraft
%   \cleardoublepage
%   \chapter*{Methods working notes (not for submission)}
%   \addcontentsline{toc}{chapter}{\protect\numberline{}Working notes}
%   \input{Chapters/99WorkingNotesMethods}
%   \cleardoublepage
% \fi
